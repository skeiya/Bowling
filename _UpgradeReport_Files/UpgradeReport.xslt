...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">プロジェクト</th>
        <th _locID="PathTableHeader">パス</th>
        <th _locID="ErrorsTableHeader">エラー</th>
        <th _locID="WarningsTableHeader">警告</th>
        <th _locID="MessagesTableHeader">メッセージ</th>
      </tr>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          その他の<xsl:value-of select="@MessageCount"/> メッセージを表示する
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          その他の<xsl:value-of select="@MessageCount"/> メッセージを隠す
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <xsl:for-each select="Project">
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">メッセージ</th>
        </tr>
          ...
          <xsl:when test="@TotalCount = 0">
            <tr>
              ...
              <td class="messageCell" _locID="NoMessagesRow">
                <xsl:value-of select="@ProjectDisplayName"/> メッセージは記録されていません。
              </td>
            </tr>
          </xsl:when>
        </xsl:choose>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          変換レポート - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">概要</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">ソリューションおよびプロジェクト</h2>
